...
MODELS = [
    Category('Choice without a Default Alternative', (
        Category('Forced Choice', (
            ...
            mgroup('Undominated Choice (incomplete preferences)',
            ...
            mgroup('Partially Dominant Forced Choice (incomplete preferences)',
        ...
        Category('Non-Forced Choice', (
            ...
            mgroup('Maximally Dominant Choice (incomplete preferences)',
            ...
            mgroup('Partially Dominant Non-Forced Choice (incomplete preferences)',
    ...
    Category('Choice with a Default Alternative', (
        mgroup('Status-Quo-Biased Undominated Choice (Bewley - incomplete preferences)',
