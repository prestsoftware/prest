...
tbl_subject = dataset.tbl_subject('tuple_intrans_menus_subject')
tbl_row = sa.Table('tuple_intrans_menus_row', dataset.metadata,
    ...
    sa.Column('garp_menu_tuples', sa.String, nullable=False),  # comma-semicolon-colon separated set of sets of sets
