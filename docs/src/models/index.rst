...
For **general/non-budgetary datasets**, Prest |version| can estimate non-parametrically which model (or models) in its 
...
Generalizing the Houtman-Maks [houtman-maks85]_ method in the *model-based* way that was suggested in [CCGT16]_,  Prest |version| computes the **distance score** 
